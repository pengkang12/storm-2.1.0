...
#sudo tc qdisc add dev $device parent 1:10 handle 10: netem delay 15ms
...
sudo tc filter add dev $device parent 1: protocol ip prio 10 u32 match ip dst $worker1 flowid 1:10
