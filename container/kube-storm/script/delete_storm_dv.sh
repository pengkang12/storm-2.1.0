...
export slotNum=2
envsubst < storm-worker-deploy-template.yaml | kubectl delete -f -
envsubst < storm-worker-service-template.json | kubectl delete -f -
done
done
...
export slotNum=8
envsubst < storm-master-deploy.yaml | kubectl delete -f -
envsubst < storm-master-service.json | kubectl delete -f -
